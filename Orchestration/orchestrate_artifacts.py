...
def main_flow_artifact(
    train_path: str = "C:/Users/user/Desktop/MLOPS/MLOPS/data/green_tripdata_2023-02.parquet",
    val_path: str = "C:/Users/user/Desktop/MLOPS/MLOPS/data/green_tripdata_2023-03.parquet",
) -> None:
